<template>
  <div class="w-icon">
    <div v-if="sunshower" class="icon sun-shower">
      <div class="cloud"></div>
      <div class="sun">
        <div class="rays"></div>
      </div>
    ...
    <div v-if="thunderstorm" class="icon thunder-storm">
      <div class="cloud"></div>
      <div class="lightning">
        <div class="bolt"></div>
        <div class="bolt"></div>
    ...
    <div v-if="cloudy" class="icon cloudy">
      <div class="cloud"></div>
      <div class="cloud"></div>
    </div>

    <div v-if="flurries" class="icon flurries">
      <div class="cloud"></div>
      <div class="snow">
        <div class="flake"></div>
        <div class="flake"></div>
    ...
    <div v-if="sunny" class="icon sunny">
      <div class="sun">
        <div class="rays"></div>
      </div>
    </div>

    <div v-if="rainy" class="icon rainy">
      <div class="cloud"></div>
      <div class="rain"></div>
    </div>
  </div>
